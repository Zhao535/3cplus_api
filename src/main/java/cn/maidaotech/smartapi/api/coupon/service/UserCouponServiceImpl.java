...
public class UserCouponServiceImpl implements UserCouponService {
    ...
    @Override
    public List<UserCoupon> findByUserId() {
        List<UserCoupon> list = userCouponRepository.findAllByUserId(UserContexts.requestUserId());
        wrapCoupon(list);
        return list;
    }
    ...
    @Override
    public List<UserCoupon> findByUserIdAndStatus(Byte status) {
